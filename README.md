...
![Logo de Markdown](images/Empathymap1.png)

**Luis Gomez**

![Logo de Markdown](images/Empathymap2.png)
...
|TS04|Procesar Pagos|**Como** Developer **Quiero** que mi plqtaforma pued procesr pgos **Para que** las tiendas puedan efecturlas| **Escenario 1:** El developer sistemiza los pagos<br>**Dado que** El developer está en el backend **Cuando** desarroll el API service de pagos. **Entonces** lo programa con flujo normal.|ES02|
